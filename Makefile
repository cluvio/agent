...
build-agent-aarch64-macos: export SDKROOT = $(shell xcrun -sdk macosx13.1 --show-sdk-path)
build-agent-aarch64-macos: export MACOSX_DEPLOYMENT_TARGET = $(shell xcrun -sdk macosx13.1 --show-sdk-platform-version)
